...
public class LironahInstaller extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // install definitions 
        String path="/sdcard/gobandroid/skins/lironah/";
        install_hash=new HashMap<Integer,String>();
        
        install_hash.put(R.drawable.black, "black17.png");
        install_hash.put(R.drawable.white, "white17.png");
        
        install_hash.put(R.drawable.black2, "black32.png");
        install_hash.put(R.drawable.white2, "white32.png");
        
        install_hash.put(R.drawable.black3, "black64.png");
        install_hash.put(R.drawable.white3, "white64.png");
        
        install_hash.put(R.drawable.shinkaya, "board.jpg");
        // prepare the path
